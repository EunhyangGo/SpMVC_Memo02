...
public class MemoService {
	...
	/*
	 * TDD(Text Driven Developer)
	 * 1. MemoService 클래스의 어떤 메서드를 호출해서 사용할 곳에서
	 * 	  먼저 method 사용(호출) 코드를 작성
	 * 2. 당연히 문법 오류가 발생할것이므로 이클립스의 도움을 받아서
	 * 3. create method를 실행한다.
	 * 4. 이클립스는 MemoService클래스에 자동으로 매개변수와 리턴값까지 설정하여
	 * 	  메서드를 작성 해 준다.	 */
